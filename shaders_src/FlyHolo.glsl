...
// v2 (11.09 Pavlo: "stronger, softer rim; paint them nicely"):
...
// Source of the Custom Code node in Spectacles-5.23 FlyHolo.graphShader and Spectacles-5.15 FlyHolo.ss_graph:
// edit here, then paste the body into the node (ASCII only).
