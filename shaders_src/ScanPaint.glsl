// ScanPaint - the intro room scan (11.09 the user: "paint the world mesh during the scan, the grid in
...
void main() {
    ...
    vec3 paint = mix(vec3(0.5, 0.55, 0.6), bc.rgb * 1.8, bc.a);
    float fill = 0.03 + 0.6 * bc.a;
    ...
    vec3 col = (paint * (line * lineK + fill) + color.rgb * edge * 1.6) * alive * intensity;
