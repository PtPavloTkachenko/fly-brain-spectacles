// NeonBatch - many neon quads in ONE draw call (11.09 perf pass). Same look as NeonGlow, but the
...
void main() {
    ...
    if (gf.x > 1.5) shape = 1.0; // 2 = solid fill corner to corner (plates, 15.09)
