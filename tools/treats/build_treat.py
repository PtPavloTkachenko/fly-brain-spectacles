...
Why: the first treat was a 4.4 MB "honey banana slice" nobody could read at 8 cm (12.09 the user:
...
ref = glb_extent(ROOT / "Spectacles" / "Assets" / "Fly" / "Treats" / "honey banana slice.glb")
target = ref if ref else 1.0
for v in obj.data.vertices:
