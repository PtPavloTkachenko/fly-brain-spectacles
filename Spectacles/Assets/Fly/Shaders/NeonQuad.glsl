// NeonQuad - one shader for the status board bars/tabs, the glow under the selected fly
...
input_color4 color = vec4(0.2, 1.0, 0.45, 1.0);
...
void main() {
    ...
    vec3 col = color.rgb * intensity * shape;
