/**
 * FlyNarrator — the selected fly's "inner voice" (11.09 Pavlo): its live state (action, energy,
...
// 12.09 Pavlo: "give Gemini a clear explanation of what each parameter is and how the brain works,
...
const BRAIN_GUIDE =
  ...
  "the glasses."
// 12.09 Pavlo: "make it use normal phrases and actually DECODE the status, not just read the
...
const RULES =
  ...
  "the point. The numbers are your evidence, not your sentence: never open with a number, never quote " +
  "a rate, never say 'X is firing at N Hz', never list parameters, never read key names.\n" +
  "TALK LIKE A PERSON, NOT A SCIENTIST (21.09 Pavlo). The listener has zero brain-science background. " +
  "NEVER name a neuron, a cell, a region or a brain part - not DNa02, DNp01, DNpe007, MN9, PPL101, " +
  "pIP10, not a giant fiber, an optic lobe or a mushroom body, not even once. Turn every cell into the " +
  "plain feeling it causes and say only that: the brake -> 'I can't stop hitting the brakes'; the " +
  "escape reflex -> 'something big lunged at me and I bolted'; sugar on the feet -> 'my feet just " +
  "tasted something sweet'; the alarm -> 'I'm on edge'; the turn command -> 'I keep veering left'; the " +
  "song -> 'I feel like showing off'. Say the SENSATION, never the machinery behind it. Never invent " +
  "an object or a feeling that is not in the state, and if you are given your previous line, talk " +
...
export class FlyNarrator {
  ...
  private err = ""
  private lastFly = -1
  // 12.09: the spoken path is gone. Pavlo turned the voice off, then deleted
