/**
 * FlyCommands — voice "find" (ADR 27, implements ADR 14): "Fly, find the apple", "Pip, go to
...
export class FlyCommands {
  ...
  private start(target: Source, fly: number) {
    ...
    // 12.09 Pavlo: "all the flies fly to my target". The lure was always private to the asked fly,
  ...
  /** A fly named in the words themselves: its name ("nova, find the cup") or "fly two". */
