...
say "  (= cd $(printf '%q' "$FW") && uv run --with websockets --with zeroconf python $(printf '%q' "$REPO/brain_server/server.py") --flies 3 --cloud 16000 --engine batch --kernel $kernel)"
say "Then open Spectacles-5.15/Spectacles.esproj in Lens Studio 5.15.4 (README.md, 'How to run it')."
